    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if result['status'] == 'missing_data':
                ...
                return render(request, 'ai_analysis/analysis_form.html', {
                    'form': form,
                    'missing_data': result['missing_fields'],
                    'message': result['message'],
                })
            
            return render(request, 'ai_analysis/analysis_result.html', {
                'result': result,
                'form': form,
            })
    else:
...
def auto_detect(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'ai_analysis/detection_results.html', {
            'results': results,
        })
    return render(request, 'ai_analysis/detection_results.html', {
        'results': [],
