...
class GoodsReceivedNote(models.Model):
    STATUS_CHOICES = [('draft', 'مسودة'), ('confirmed', 'مؤكد')]

    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    grn_number = models.CharField(max_length=50, unique=True, blank=True, verbose_name='رقم إيصال الاستلام')
    ...
    warehouse = models.ForeignKey(
        'warehouses.Warehouse', on_delete=models.PROTECT, null=True, blank=True, verbose_name='المستودع'
    )
...
class GoodsReceivedLine(models.Model):
    ...
    grn = models.ForeignKey(
        GoodsReceivedNote, on_delete=models.CASCADE, related_name='lines', verbose_name='إيصال الاستلام'
    )
    ...
    unit_price = models.DecimalField(max_digits=20, decimal_places=2, default=0, verbose_name='سعر الوحدة')
    notes = models.TextField(blank=True, null=True, verbose_name='ملاحظات')
