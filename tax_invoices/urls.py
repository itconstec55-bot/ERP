...
urlpatterns = [
    ...
    path(
        'invoices/create-from/<uuid:sales_pk>/',
        views.tax_invoice_create_from_sales,
        name='tax_invoice_create_from_sales',
    ),
    path('invoices/<uuid:pk>/check-status/', views.tax_invoice_check_status, name='tax_invoice_check_status'),
    path('invoices/<uuid:pk>/void/', views.tax_invoice_void, name='tax_invoice_void'),
]
