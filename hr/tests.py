...
from hr.models import Attendance, Department, Employee, LeaveType
...
class TestAttendance:
    def test_create(self, admin_user):
        ...
        att = Attendance.objects.create(employee=emp, date=date(2026, 7, 20), check_in='08:00', check_out='16:00')
