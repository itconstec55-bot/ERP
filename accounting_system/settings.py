...
# APM: Sentry (خطأ التتبع في الإنتاج)
...
# APM: Silk (توصيف الطلبات للتطوير)
SILKY_PYTHON_PROFILER = bool(os.environ.get('SILKY_PYTHON_PROFILER', 'False').lower() in ('true', '1', 'yes'))
...
if os.environ.get('DJANGO_CHANNELS_REDIS'):
    CHANNEL_LAYERS = {
        'default': {
            'BACKEND': 'channels_redis.core.RedisChannelLayer',
            'CONFIG': {'hosts': [os.environ['DJANGO_CHANNELS_REDIS']]},
        },
    }
