...
urlpatterns = [
    ...
    path('user/<int:pk>/account-type/remove/<uuid:item_pk>/', views.user_remove_account_type, name='user_remove_account_type'),
    ...
    path('user/<int:pk>/exception/remove/<uuid:item_pk>/', views.user_remove_screen_exception, name='user_remove_screen_exception'),
