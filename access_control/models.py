...
GRANT_TYPES = [('allow', 'سماح'), ('deny', 'حرمان صريح')]
...
class Role(models.Model):
    ...
    is_system = models.BooleanField(
        default=False, verbose_name='دور نظامي', help_text='الأدوار النظامية جاهزة ولا يمكن حذفها'
    )
...
class Screen(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    code = models.CharField(max_length=100, unique=True, verbose_name='كود الشاشة', help_text='مثل: sales.invoice')
...
class RoleScreenPermission(ScreenAccessMixin):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    role = models.ForeignKey(Role, on_delete=models.CASCADE, related_name='screen_permissions', verbose_name='الدور')
    screen = models.ForeignKey(Screen, on_delete=models.CASCADE, related_name='role_permissions', verbose_name='الشاشة')
    grant_type = models.CharField(max_length=10, choices=GRANT_TYPES, default='allow', verbose_name='نوع المنح')
...
class UserScreenPermission(ScreenAccessMixin):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='screen_permissions', verbose_name='المستخدم')
    screen = models.ForeignKey(Screen, on_delete=models.CASCADE, related_name='user_permissions', verbose_name='الشاشة')
    grant_type = models.CharField(max_length=10, choices=GRANT_TYPES, default='allow', verbose_name='نوع المنح')
...
class UserRoleAssignment(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='role_assignments', verbose_name='المستخدم')
    role = models.ForeignKey(Role, on_delete=models.CASCADE, related_name='user_assignments', verbose_name='الدور')
    granted_by = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, related_name='granted_roles', verbose_name='مُنِح بواسطة'
    )
...
class UserBranch(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='allowed_branches', verbose_name='المستخدم')
    branch = models.ForeignKey(
        'company.CompanyBranch', on_delete=models.CASCADE, related_name='authorized_users', verbose_name='الفرع'
    )
...
class UserWarehouse(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='allowed_warehouses', verbose_name='المستخدم')
    warehouse = models.ForeignKey(
        'warehouses.Warehouse', on_delete=models.CASCADE, related_name='authorized_users', verbose_name='المخزن'
    )
...
class UserAccountTypeScope(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='allowed_account_types', verbose_name='المستخدم'
    )
    account_type = models.ForeignKey(
        'accounts.AccountType', on_delete=models.CASCADE, related_name='authorized_users', verbose_name='نوع الحساب'
    )
