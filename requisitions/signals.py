...
def _audit_requisition_save(sender, instance, created, **kwargs):
    ...
    log_action(None, 'create' if created else 'update', 'requisitions.requisition',
...
def _audit_requisition_delete(sender, instance, **kwargs):
    from audit.models import log_action
    log_action(None, 'delete', 'requisitions.requisition',
               object_id=instance.pk, object_repr=str(instance))
...
def _audit_requisition_line_save(sender, instance, created, **kwargs):
    from audit.models import log_action
    log_action(None, 'create' if created else 'update', 'requisitions.requisitionline',
               object_id=instance.pk, object_repr=str(instance))
...
def _audit_requisition_line_delete(sender, instance, **kwargs):
    from audit.models import log_action
    log_action(None, 'delete', 'requisitions.requisitionline',
               object_id=instance.pk, object_repr=str(instance))
