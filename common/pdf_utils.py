...
def export_to_pdf(title, headers, rows, filename='report', summary=None):
    ...
    try:
        ...
        title_style = ParagraphStyle(
            'ArabicTitle', parent=styles['Title'], fontName=ARABIC_FONT, fontSize=16, alignment=1, spaceAfter=10
        )
        ...
        cell_style = ParagraphStyle(
            'ArabicCell', parent=styles['Normal'], fontName=ARABIC_FONT, fontSize=8, alignment=1
        )
        summary_style = ParagraphStyle(
            'Summary', parent=styles['Normal'], fontName=ARABIC_FONT, fontSize=10, alignment=1, spaceBefore=10
        )
        ...
        date_style = ParagraphStyle(
            'Date', parent=styles['Normal'], fontName=ARABIC_FONT, fontSize=8, alignment=1, textColor=colors.grey
        )
